import { Body, Controller, ForbiddenException, Get, Header, NotFoundException, Post, Query, Res } from '@nestjs/common'
...
export class RunnerController {
    ...
    video(@Query('path') path: string, @Res() res: ServerResponse): void {
        this.ensureTestMode()
