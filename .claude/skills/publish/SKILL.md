---
name: publish
description: Use when publishing @acutis/cli to npm, cutting a release, bumping the version or debugging a failed release workflow. Covers the 2FA flow, the OIDC workflow and the traps of the installed package.
---

# Publicar o @acutis/cli
