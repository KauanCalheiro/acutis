...
**How to apply:** ao terminar uma mudança que toca o frontend, rodar `pnpm lint`, `pnpm typecheck`, a suíte do backend e o teste E2E específico da mudança. Reportar o resultado real da execução; se o teste falhar, corrigir antes de entregar. Ver a skill `run-e2e` para as armadilhas do `--grep` e do build no `pretest`.
