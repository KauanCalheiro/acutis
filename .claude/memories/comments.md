...
**How to apply:** ao escrever ou revisar qualquer código do projeto (backend, frontend, extension), se sentir vontade de explicar algo com `//` ou docblock, pare e renomeie a variável/função/arquivo até o código falar sozinho. `@ts-expect-error` e diretivas de compilador não contam como comentário — mas não adicionar texto explicativo depois deles.
