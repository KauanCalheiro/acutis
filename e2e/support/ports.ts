/**
 * Faixa 42xx, exclusiva do E2E. As portas de desenvolvimento (backend 8000, frontend 3000,
 * webdriver 4000) ficam livres, então a suíte roda com a stack local de pé — sem derrubar nada.
 *
