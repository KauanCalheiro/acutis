...
Route::get('projects/{project}/environments', [ProjectController::class, 'environments']);
Route::post('projects/{project}/environments', [ProjectController::class, 'storeEnvironment']);
Route::put('projects/{project}/environments/{environment}', [ProjectController::class, 'updateEnvironment']);
Route::delete('projects/{project}/environments/{environment}', [ProjectController::class, 'destroyEnvironment']);
Route::post('projects/{project}/environments/{environment}/activate', [ProjectController::class, 'activateEnvironment']);
Route::get('projects/{project}/env', [ProjectController::class, 'dotenv']);
Route::put('projects/{project}/env', [ProjectController::class, 'updateDotenv']);
...
Route::post('projects/{project}/auth/credentials', [ProjectController::class, 'authCredentials']);
