...
import { UpdateScenarioDto } from '../../dto/scenario/update-scenario.dto.js'
import type { ScenarioResponse } from '../../dto/scenario/responses/scenario.response.js'
...
export class ScenarioController {
    constructor(
        private readonly scenarios: ScenarioUseCases,
    ...
    async run(
        ...
        const result = await this.runScenario.execute(slug, spec, grep)
    ...
    async runStream(
        ...
        await this.runScenario.stream(slug, spec, grep, (event) => {
