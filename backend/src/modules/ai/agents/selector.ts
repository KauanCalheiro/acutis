/**
 * Batiza `data-testid` para elementos que hoje dependem de seletor frágil. O `index` que entra
 * volta inalterado na resposta, e é ele que liga a sugestão ao elemento gravado.
 */
