...
/**
 * Um evento como o gravador o registra.
 *
 * Quase tudo é opcional porque uma gravação antiga pode não ter o campo que uma versão nova passou
 * a capturar — e porque o `html` é removido de verdade quando os eventos saem daqui, não anulado.
 */
