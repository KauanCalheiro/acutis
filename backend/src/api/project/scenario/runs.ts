/**
 * O histórico de execuções de um cenário.
 *
 * Um arquivo ndjson por cenário, e não um por execução: a listagem precisa das últimas em ordem, e
 * ler um diretório inteiro de arquivinhos para montar isso custaria mais do que ler uma linha por
 * execução.
 */
