 ...
 *
 * Tudo aqui é leitura e reescrita de texto — título, cenário e tags — porque é por esses três que o
 * usuário renomeia um teste pela interface sem abrir o arquivo.
 */
...
/**
 * O modelo às vezes devolve a feature inteira numa linha só. Sem cortar na próxima cláusula, o
 * título viria com o cenário e os passos grudados.
 */
