 ...
 *
 * Os dois andam juntos de propósito: o `.env` guarda os valores e não é versionado, o `.example`
 * guarda só as chaves e é. Quem clona o projeto vê o que precisa preencher sem receber o segredo de
 * ninguém.
 */
import { existsSync, readFileSync, writeFileSync } from 'node:fs'
import { join } from 'node:path'
import { EnvKey } from '../project/environment/env-key.js'
import { fromLine } from '../project/environment/environment-var.js'
...
export class Dotenv {
    ...
    merge(values: Record<string, string>): void {
        ...
        // O exemplo leva as chaves sem os valores — menos o ambiente ativo, que é estado local de
        // quem está usando a máquina e não diz nada a quem clona.
