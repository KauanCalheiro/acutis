...
import { templateFile } from '../template.js'
...
/**
 * O bloco que separa o login dos cenários: o `setup` roda antes, os públicos rodam sem sessão, e os
 * demais herdam a sessão que o login salvou.
 */
