 ...
 *
 * Toda uma delas já esteve em prosa num prompt: lá competia por atenção com as outras vinte e
 * falhava calada. Tirar uma daqui é apagar uma linha.
 */
import { EnvKey, ownsKey } from '../project/environment/env-key.js'
import type { ActiveVars } from '../playwright/active-vars.js'
import type { Playwright } from '../playwright/playwright.js'
...
/**
 * Sistema com SSO redireciona sozinho para a tela de login e traz o callback de volta; abrir o host
 * do SSO direto perde esse retorno e a sessão não se forma.
 */
