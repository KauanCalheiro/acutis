 ...
 *
 * Instruções portadas do `GherkinWriter` do Laravel, palavra por palavra: elas foram ajustadas
 * contra o comportamento real dos modelos, e reescrevê-las com outras palavras é recomeçar esse
 * ajuste do zero.
 */
