/** O login gravado que vira o `auth.setup.ts`. */
...
import type { AuthRecordingRequest } from '@acutis/contracts/auth'
...
export class AuthRecordingDto implements AuthRecordingRequest {
