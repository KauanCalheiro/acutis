/**
 * O formulário de clone. O nome é opcional — sem ele, sai do último segmento da URL —, e a colisão
 * de projeto é validada sobre o nome derivado.
 */
import {
    IsIn,
    IsNotEmpty,
...
import type { CloneProjectRequest } from '@acutis/contracts/project'
...
export class CloneProjectDto implements CloneProjectRequest {
