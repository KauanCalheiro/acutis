...
class PlaywrightWriter implements Agent, HasStructuredOutput
{
    ...
    public function instructions(): string
    {
        ...
        - O test.describe SEMPRE declara as mesmas tags do Gherkin via option tag: test.describe('Título', { tag: ['@read', '@dominio'] }, () => { ... }) — a primeira é exatamente uma entre @read e @write.
