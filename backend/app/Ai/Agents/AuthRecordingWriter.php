...
class AuthRecordingWriter implements Agent, HasStructuredOutput
{
    ...
    public function instructions(): string
    {
        ...
        - A ÚNICA URL que pode aparecer no arquivo é a "URL pós-login" informada no prompt. Nunca deduza, adivinhe, encurte ou monte uma URL a partir do nome do sistema, de um label ou de um evento de clique.
        - Com uma "URL pós-login" informada, confirme o login com await page.waitForURL('<URL pós-login>') seguido de await expect(page).toHaveURL('<URL pós-login>'), copiando a URL literalmente como veio.
